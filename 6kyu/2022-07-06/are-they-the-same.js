...
function comp(array1, array2){
    //Parameters: 2 arrays of numbers, not sorted
    //Return: a boolean, depending on if each value of arr2 is the square of the elements of arr1.
    //Example: a = [121, 144, 19, 161, 19, 144, 19, 11]  
    //b = [121, 14641, 20736, 361, 25921, 361, 20736, 361] -> returns TRUE
    //Pseudo-code: I will create an array of squares, and see if the second array matches it.
